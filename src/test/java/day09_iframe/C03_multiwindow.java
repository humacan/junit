...
import utilities.TestBase;
    ...
    public class C03_multiwindow extends TestBase {
    @Test
    public void test01(){
        ...
        String amazonWhd= driver.getWindowHandle(); //driver in bu sayfaya geri donmesi icin isaret biraktik
        ...
        Assert.assertTrue(actualUrl.contains(expectedUrlIcerik));
        String wiseWhd= driver.getWindowHandle(); //driver in bu sayfaya geri donmesi icin isaret biraktik
